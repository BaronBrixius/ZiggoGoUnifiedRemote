	...
	class Page
	{
		...
		*/
		Call(DomainAndMethod, Params:="", WaitForResponse:=True)
		{
			...
			;removing error popups because they aren't useful for this
			;if (response.error)
		...
		*/
		...
		{
			totalSleepTime := 0
			while (this.Evaluate("document.readyState").value != DesiredState && totalSleepTime < Interval * 30) {
				Sleep, Interval
